...
prod_requirements = ["argcomplete", "click", "colorlog", "crayons", "requests", "SQLAlchemy", "plumbum", "prettyconf"]

dev_requirements = ["coverage", "docutils", "nitpick", "pytest-cov", "pytest", "Sphinx", "tox"]
...
setup(
    ...
    cmdclass={"publish": PublishCommand, "test": PyTest},
    test_suite="tests",
