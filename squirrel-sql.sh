...
IZPACK_JAVA_HOME=/usr/lib/jvm/java-6-openjdk/jre
...
# SQuirreL home.
if $macosx ; then
	SQUIRREL_SQL_HOME='/usr/local/share/squirrel-sql-3.3.0/Contents/Resources/Java'
else 
	SQUIRREL_SQL_HOME='/usr/local/share/squirrel-sql-3.3.0'
fi
