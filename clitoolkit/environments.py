...
config.starting_path = os.path.expanduser('~/.config/clitoolkit')

RSYNC_EXCLUDE = config('RSYNC_EXCLUDE', cast=config.list,
                       default='lost+found/,.dropbox.cache,.Trash-*,.DS_Store')  # type: List[str]
